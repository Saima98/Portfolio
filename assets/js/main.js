...
function border_hover(a) {
	var b = document.getElementsByClassName("border-hover");
	for (var i = 0; i < b.length; i++) {
		b[i].style.backgroundColor = a;
	}
}
...
function slick_btn(a) {
	var b = document.getElementsByClassName("slick-btn");
	for (var i = 0; i < b.length; i++) {
...
function img_back_2(a) {
	...
	for (var i = 0; i < b.length; i++) {
		if (a == "#16ac49") {
			...
			b[i].style.backgroundColor = "#4747B7AD  ";
		} else if (a == "#4d0857") {
